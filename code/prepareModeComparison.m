...
% --------------------------
% Process each mode or selected modes
% --------------------------
show = @(n) strcmp(opts.modeplot.plotted_modes, 'all') || ismember(n, opts.modeplot.plotted_modes);
for i = 1:N_modes
    if show(i)
        ...
        x_detrendResults = detrend(tx_seg,X(opts.skip_xerom+1:end,i),opts.modefit_xerom);
